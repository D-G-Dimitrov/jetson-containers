...
package = [
    sglang('0.5.9', '0.5.9', depends=['flashinfer', 'sgl-kernel:0.3.21', 'torchao:0.9.0'], default=False),
    sglang('0.6.0', '0.6.0', depends=['flashinfer', 'sgl-kernel:latest', 'torchao:0.9.0'], default=True), # Compatible with CUDA 13 (Spark and Thor)
]
